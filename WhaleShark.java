...
public class WhaleShark extends Animals {

    private double runDistanceInKm;
    private double runSpeedInKmPerHour;
    public WhaleShark(String name, String animalType, DietType dietType, int age, double runDistanceInKm, double runSpeedInKmPerHour) {
